...
(function () {
  ...
  // roughmap needs a per-map key generated by hand on map.kakao.com). While
  // this is empty the section falls back to the embed it carried before, so it
  // is never blank -- filling the key in is the only step needed to switch.
  var KAKAO_JS_KEY = '';
